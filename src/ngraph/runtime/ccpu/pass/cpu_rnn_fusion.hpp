...
class ngraph::runtime::ccpu::pass::LSTMFusion : public ngraph::pass::GraphRewrite
{
public:
    LSTMFusion()
        : GraphRewrite()
...
class ngraph::runtime::ccpu::pass::RNNFusion : public ngraph::pass::RecurrentGraphRewrite
{
public:
    RNNFusion()
...
class ngraph::runtime::ccpu::pass::MultiLayerRNNFusion : public ngraph::pass::RecurrentGraphRewrite
{
public:
    MultiLayerRNNFusion()
        : RecurrentGraphRewrite()
