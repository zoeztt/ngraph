#ifndef HALIDE__batch_norm_h
#define HALIDE__batch_norm_h
#include <stdint.h>
...
int batch_norm(struct halide_buffer_t *_p2_buffer, struct halide_buffer_t *_p0_buffer, struct halide_buffer_t *_p1_buffer, float _p3, struct halide_buffer_t *_mean_buffer, struct halide_buffer_t *_variance_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int batch_norm_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *batch_norm_metadata() HALIDE_FUNCTION_ATTRS;
...
inline const struct halide_filter_metadata_t* (*HALIDE_GET_STANDARD_METADATA_FUNCTION())() {
    return batch_norm_metadata;
}
#endif


int batch_norm_old_buffer_t(struct buffer_t *_p2, struct buffer_t *_p0, struct buffer_t *_p1, float _p3, struct buffer_t *_mean, struct buffer_t *_variance, struct buffer_t *_output) HALIDE_FUNCTION_ATTRS;
