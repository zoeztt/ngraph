...
void regclass_pyngraph_op_Constant(py::module m)
{
    ...
    constant.def(py::init<const ngraph::Type&, const ngraph::Shape&, const std::vector<char>&>());
    constant.def(py::init<const ngraph::Type&, const ngraph::Shape&, const std::vector<float>&>());
    constant.def(py::init<const ngraph::Type&, const ngraph::Shape&, const std::vector<double>&>());
    constant.def(py::init<const ngraph::Type&, const ngraph::Shape&, const std::vector<int8_t>&>());
    constant.def(
        py::init<const ngraph::Type&, const ngraph::Shape&, const std::vector<int16_t>&>());
    constant.def(
        py::init<const ngraph::Type&, const ngraph::Shape&, const std::vector<int32_t>&>());
    constant.def(
        py::init<const ngraph::Type&, const ngraph::Shape&, const std::vector<int64_t>&>());
    constant.def(
        py::init<const ngraph::Type&, const ngraph::Shape&, const std::vector<uint8_t>&>());
    constant.def(
        py::init<const ngraph::Type&, const ngraph::Shape&, const std::vector<uint16_t>&>());
    constant.def(
        py::init<const ngraph::Type&, const ngraph::Shape&, const std::vector<uint32_t>&>());
    constant.def(
        py::init<const ngraph::Type&, const ngraph::Shape&, const std::vector<uint64_t>&>());
    ...
    constant.def_buffer([](const ngraph::op::Constant& self) -> py::buffer_info {
        ...
        if (element_type == ngraph::boolean)
        {
        ...
        else if (element_type == ngraph::f64)
        {
            return _get_buffer_info<double>(self);
        }
        else if (element_type == ngraph::i8)
        {
            return _get_buffer_info<int8_t>(self);
        }
        else if (element_type == ngraph::i16)
        {
        ...
        else if (element_type == ngraph::u16)
        {
            return _get_buffer_info<uint16_t>(self);
        }
        else if (element_type == ngraph::u32)
        {
            return _get_buffer_info<uint32_t>(self);
        }
        else if (element_type == ngraph::u64)
        {
