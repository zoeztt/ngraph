...
TEST(builder, scaled_QMP_unsigned)
{
    ...
    auto A = make_shared<op::Parameter>(u8, shape_a);
    auto B = op::Constant::create(f32, Shape{1}, {0.0f});
    auto C = op::Constant::create(f32, Shape{1}, {255.0f});
    ...
    auto a = backend->create_tensor(u8, shape_a);
    copy_data(a, a_data);
    auto result = backend->create_tensor(u8, shape_r);
...
TEST(builder, scaled_QMP_signed)
{
    ...
    Shape padding_above{0, 0};
    Shape shape_r{1, 1, 2, 3};
    auto A = make_shared<op::Parameter>(i8, shape_a);
    auto B = op::Constant::create(f32, Shape{1}, {0.0f});
    auto C = op::Constant::create(f32, Shape{1}, {127.0f});
    auto QMP = ngraph::builder::ScaledQuantizedMaxPool(
        A, window_shape, window_movement_strides, padding_below, padding_above, B, C);
    auto f = make_shared<Function>(NodeVector{QMP}, ParameterVector{A});
    auto backend = runtime::Backend::create("CPU");
    // Create some tensors for input/output
    auto a = backend->create_tensor(i8, shape_a);
    copy_data(a, a_data);
    auto result = backend->create_tensor(i8, shape_r);
    backend->call_with_validate(backend->compile(f), {result}, {a});
...
TEST(builder, scaled_QC)
{
    ...
    auto A = make_shared<op::Parameter>(u8, shape_a);
    auto B = make_shared<op::Parameter>(i8, shape_b);
    auto C = op::Constant::create(f32, Shape{1}, {0.0f});
    auto D = op::Constant::create(f32, Shape{1}, {255.0f});
    auto E = op::Constant::create(f32, Shape{1}, {-127.0f});
    auto F = op::Constant::create(f32, Shape{1}, {127.0f});
    auto G = op::Constant::create(f32, Shape{1}, {22.0f});
    auto H = op::Constant::create(f32, Shape{1}, {90.0f});
    ...
    auto a = backend->create_tensor(u8, shape_a);
    copy_data(a, a_data);
    auto b = backend->create_tensor(i8, shape_b);
    copy_data(b, b_data);
    auto result = backend->create_tensor(i8, shape_r);
...
TEST(builder, scaled_QC_with_relu)
{
    ...
    auto E = op::Constant::create(f32, Shape{1}, {-127.0f});
    auto F = op::Constant::create(f32, Shape{1}, {127.0f});
    auto G = op::Constant::create(f32, Shape{1}, {20.0f});
    auto H = op::Constant::create(f32, Shape{1}, {-24.0f});
...
TEST(builder, scaled_QC_with_bias)
{
    ...
    auto A = make_shared<op::Parameter>(u8, shape_a);
    auto B = make_shared<op::Parameter>(i8, shape_b);
    auto Bias = make_shared<op::Parameter>(i32, Shape{1});
    auto C = op::Constant::create(f32, Shape{1}, {0.0f});
    auto D = op::Constant::create(f32, Shape{1}, {255.0f});
    auto E = op::Constant::create(f32, Shape{1}, {-127.0f});
    auto F = op::Constant::create(f32, Shape{1}, {127.0f});
    ...
    auto b = backend->create_tensor(i8, shape_b);
    copy_data(b, b_data);
    auto c = backend->create_tensor(i32, Shape{1});
    copy_data(c, c_data);
    auto result = backend->create_tensor(i8, shape_r);
...
TEST(builder, scaled_QC_with_bias_add_and_relu)
{
    ...
    auto A = make_shared<op::Parameter>(u8, shape_a);
    auto B = make_shared<op::Parameter>(i8, shape_b);
    auto Add = make_shared<op::Parameter>(u8, shape_a);
    auto Bias = make_shared<op::Parameter>(i32, Shape{1});
    auto C = op::Constant::create(f32, Shape{}, {0.0f});
    auto D = op::Constant::create(f32, Shape{}, {255.0f});
    auto E = op::Constant::create(f32, Shape{}, {-127.0f});
    auto F = op::Constant::create(f32, Shape{}, {127.0f});
    auto G = op::Constant::create(f32, Shape{}, {22.0f});
    auto H = op::Constant::create(f32, Shape{}, {90.0f});
    auto I = op::Constant::create(f32, Shape{}, {22.0f});
    auto J = op::Constant::create(f32, Shape{}, {180.0f});
    ...
    auto c = backend->create_tensor(i32, Shape{1});
    copy_data(c, c_data);
    auto d = backend->create_tensor(u8, shape_a);
...
TEST(builder, scaled_QC_with_bias_signed_add_and_relu)
{
    ...
    auto A = make_shared<op::Parameter>(u8, shape_a);
    auto B = make_shared<op::Parameter>(i8, shape_b);
    auto Add = make_shared<op::Parameter>(i8, shape_a);
    auto Bias = make_shared<op::Parameter>(i32, Shape{1});
    auto C = op::Constant::create(f32, Shape{}, {0.0f});
    auto D = op::Constant::create(f32, Shape{}, {255.0f});
    auto E = op::Constant::create(f32, Shape{}, {-127.0f});
    ...
    auto H = op::Constant::create(f32, Shape{}, {90.0f});
    auto I = op::Constant::create(f32, Shape{}, {22.0f});
    auto J = op::Constant::create(f32, Shape{}, {90.0f});
    auto CV =
    ...
    auto c = backend->create_tensor(i32, Shape{1});
    copy_data(c, c_data);
    auto d = backend->create_tensor(i8, shape_a);
    copy_data(d, conv_2_data);
    auto result = backend->create_tensor(u8, shape_r);
    auto handle = backend->compile(f);
    backend->call_with_validate(handle, {result}, {a, b, c, d});
...
TEST(builder, scaled_QC_with_f32_bias_and_relu)
{
    ...
    auto E = op::Constant::create(f32, Shape{}, {-127.0f});
    auto F = op::Constant::create(f32, Shape{}, {127.0f});
    auto G = op::Constant::create(f32, Shape{}, {20.0f});
    auto H = op::Constant::create(f32, Shape{}, {-24.0f});
    auto CV = ngraph::builder::ScaledQuantizedConvolutionBias(A,
                                                              B,
                                                              Bias,
                                                              Strides{1, 1}, // move_strides
    ...
    auto b = backend->create_tensor(i8, shape_b);
    copy_data(b, b_data);
    auto c = backend->create_tensor(f32, Shape{1});
    copy_data(c, c_data);
    auto result = backend->create_tensor(u8, shape_r);
    backend->call_with_validate(backend->compile(f), {result}, {a, b, c});
    EXPECT_EQ((vector<uint8_t>{0, 0, 0, 0, 0, 0, 191, 255, 234}), read_vector<uint8_t>(result));
...
TEST(builder, scaled_Q_unsigned)
{
    ...
    auto B = op::Constant::create(f32, Shape{}, {-255.0f});
    auto C = op::Constant::create(f32, Shape{}, {127.0f});
    auto QT = ngraph::builder::ScaledQuantize(A, B, C, u8, quantization_axes, round_mode);
    ...
    copy_data(a, a_data);
    auto result = backend->create_tensor(u8, shape_a);
    backend->call_with_validate(backend->compile(f), {result}, {a});
...
TEST(builder, scaled_Q_signed)
{
    ...
    op::Quantize::RoundMode round_mode = op::Quantize::RoundMode::ROUND_NEAREST_TOWARD_EVEN;
    auto A = make_shared<op::Parameter>(f32, shape_a);
    auto B = op::Constant::create(f32, Shape{}, {-127.0f});
    auto C = op::Constant::create(f32, Shape{}, {127.0f});
    auto QT = ngraph::builder::ScaledQuantize(A, B, C, i8, quantization_axes, round_mode);
    auto f = make_shared<Function>(NodeVector{QT}, ParameterVector{A});
    constant_fold(f);
    auto backend = runtime::Backend::create("CPU");
    // Create some tensors for input/output
    auto a = backend->create_tensor(f32, shape_a);
    copy_data(a, a_data);
    auto result = backend->create_tensor(i8, shape_a);
    backend->call_with_validate(backend->compile(f), {result}, {a});
...
TEST(builder, scaled_DQ_signed)
{
    ...
    AxisSet quantization_axes;
    auto A = make_shared<op::Parameter>(i8, Shape{1});
    auto B = op::Constant::create(f32, Shape{}, {-1.0f});
    auto C = op::Constant::create(f32, Shape{}, {300.0f});
    auto r = ngraph::builder::ScaledDequantize(A, B, C, f32, quantization_axes);
    auto f = make_shared<Function>(r, ParameterVector{A});
    constant_fold(f);
    auto backend = runtime::Backend::create("CPU");
    // Create some tensors for input/output
    auto a = backend->create_tensor(i8, Shape{1});
    copy_data(a, a_data);
    auto result = backend->create_tensor(f32, Shape{1});
    backend->call_with_validate(backend->compile(f), {result}, {a});
